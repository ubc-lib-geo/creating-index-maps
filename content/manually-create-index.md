...
If you intend to complete this task in more than one sitting, you will need to manually save each layer you create. Otherwise, they will not be present when you reopen the project, since they are created as temporary, or "scratch", layers. (Fortunately, QGIS will notify you if you attempt to close a project with temporary layers.) To make a layer permanent:<br>- Right-click on the layer<br>- Select **Make Permanent...**<br>- Choose the desired format and file name<br>- Click **OK**
{: .note}
